...
## 2.极限的特殊情况
下面小标题的式子在一般情况下是成立的，现在列出特殊情况。（默认 $n \rightarrow \infty$ ）
  
### 2.1 $a_n-b_n \rightarrow A-B$
$\infty - \infty$
例1：当 $a_n=n^2$ ， $b_n=n$ 时，$a_n-b_n \rightarrow \infty$ 。
例2：当 $a_n=n$ ， $b_n=n$ 时，$a_n-b_n \rightarrow 0$ 。
...
$(0)(\infty)$
例3：当 $a_n=1/n^2$ ， $b_n=n$ 时，$a_nb_n = 1/n\rightarrow 0$ 。
例4：当 $a_n=1/n$ ， $b_n=n^2$ 时，$a_nb_n = n\rightarrow \infty$ 。
